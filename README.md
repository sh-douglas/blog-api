...
Criar uma aplicação web para consumir a API.
...
5. Criar Login
6. Criar Register
7. Criar rotas protegidas
8. Criar tela de posts públicos
9. Criar dashboard privado
10. Criar gerenciamento de posts
```

---

## Melhorias futuras no backend

```txt
Listagem de usuários para director
...
O backend está funcional e pronto para ser consumido por um front-end.
...
retorno estruturado com dados do autor
```

O próximo passo recomendado é iniciar o front-end pelo fluxo de autenticação.
